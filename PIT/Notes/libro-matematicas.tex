...
\usepackage[english, es-tabla, es-lcroman, es-noquoting, es-minimal]{babel}
\usepackage{graphicx}
...
\parbox[b]{0.7\textwidth}{
  ...
  \raggedright
  \sffamily
  {\large This book is distributed under a license CC BY-NC-SA 4.0.}\\[4pt]\\[4pt]
