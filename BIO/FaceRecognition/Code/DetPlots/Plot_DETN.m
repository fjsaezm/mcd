function h = Plot_DETN (Pmiss, Pfa, plot_code, opt_thickness, opt_Style)
...
Set_DET_limits;
h = thickN(opt_Style,opt_thickness,plot(ppndf(Pfa), ppndf(Pmiss), plot_code));
Make_DET;
...
set (gca, 'xgrid', 'on');
xlabel ('False Alarm probability (in %)','FontWeight','bold','FontSize',12);
...
set (gca, 'ygrid', 'on')
ylabel ('Miss probability (in %)','FontWeight','bold','FontSize',12)
